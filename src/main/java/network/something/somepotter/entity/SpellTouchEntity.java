...
public class SpellTouchEntity extends Projectile {

    private static final EntityDataAccessor<String> SPELL_ID = SynchedEntityData.defineId(SpellTouchEntity.class, EntityDataSerializers.STRING);
