...
public class ProtegoDiabolicaParticlePacket implements ClientSideHandler {

    protected Vec3 pos;
    protected int startColor;
    protected int endColor;

    public ProtegoDiabolicaParticlePacket(Vec3 pos, Color startColor, Color endColor) {
        this.pos = pos;
